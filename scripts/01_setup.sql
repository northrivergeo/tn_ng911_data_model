...
insert into tn911.type_tbl (description, type) values ('RDG', 'RDG');
insert into tn911.type_tbl (description, type) values ('RDGS', 'RDGS');
...
insert into tn911.type_tbl (description, type) values ('TRWY', 'TRWY');

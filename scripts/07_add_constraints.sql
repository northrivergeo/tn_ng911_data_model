...
ALTER TABLE tn911.address_points ADD FOREIGN KEY (segside) REFERENCES tn911.segside_tbl(segside); 
...
ALTER TABLE tn911.centerlines ADD FOREIGN KEY (cfcc) REFERENCES references tn911.cfcc_tbl(cfcc);

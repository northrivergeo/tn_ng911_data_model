...
ogr2ogr -update -append -f "PostgreSQL" -a_srs "EPSG:2274" PG:"host=localhost user=user dbname=tndemo password=password schemas=tn911" ../data/esn_area.shp -nln tn911.esn -skipfailures

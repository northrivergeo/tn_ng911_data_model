...
CREATE TABLE tn911.address_points ( 
	...
	r_segid varchar(25), 
	a_segid varchar(25), 
	seg_side varchar(1) references forms.segside_tbl, 
	gislink varchar(15), 
	strucdomain varchar(30) references forms.strucdomain_tbl(strucdomain), 
	structype smallint references forms.structype_tbl(structype), 
	...
	building varchar(35), 
	floor varchar(10), 
	unit_type varchar(10) references forms.unit_tbl(unit_type), 
	unit_num varchar(10), 
	predir varchar(2) references forms.predir_tbl(predir), 
	pretype varchar(5) references forms.type_tbl(type), 
	name varchar(40), 
	type varchar(5) references forms.type_tbl(type), 
	sufdir varchar(2) references forms.predir_tbl(predir),
	postmod varchar(20) references forms.type_tbl(type), 
	address varchar(100), 
	addr_esn varchar(100), 
	label varchar(100), 
	subname varchar(50), 
	vanity varchar(50), 
	zip varchar(5) references forms.zipcode(zipcode), 
	zip4 varchar(4), 
	esn varchar(4), 
	city varchar(30), 
	county varchar(30), 
	...
	gpsdate timestamp, 
	addrauth varchar(50), 
	source smallint references forms.source_tbl(source), 
	editor varchar(10), 
	geomod varchar(75), 
	geosrce varchar(45), 
	geodate timestamp, 
	...
	attsrce varchar(45), 
	attdate timestamp, 
	status smallint references forms.lifecyclestatus_tbl(status), 
	delnotes varchar(75)
    ); 
...
CREATE TABLE tn911.centerlines ( 
	...
	r_f_add varchar(11), 
	r_t_add varchar(11), 
	addr_type varchar(1) references forms.addrtype_tbl(type), 
	predir varchar(2) reference forms.predir_tbl(predir), 
	pretype varchar(5) references forms.type_tbl(type), 
	name varchar(40), 
	type varchar(5) references forms.type_tbl(type), 
	sufdir varchar(2) references forms.predir_tbl(predir), 
	...
	vanity varchar(75), 
	subname varchar(50), 
	nametype smallint references forms.nametype_tbl(nametype), 
	cfcc varchar(3) references forms.cfcc_tbl(cfcc), 
	esn_l varchar(3), 
	esn_r varchar(3), 
	zip_l varchar(5) references forms.zipcode(zipcode),
	zip_r varchar(5) references forms.zipcode(zipcode),
        city_l varchar(30), 
	city_r varchar(30), 
	county_l varchar(30), 
	county_r varchar(30), 

...
ogr2ogr -update -append -f "PostgreSQL" -a_srs "EPSG:2274" PG:"host=localhost user=user dbname=tndemo password=password schemas=tn911" ../data/address_points.shp -nln tn911.addresspoints -nlt point -skipfailures
